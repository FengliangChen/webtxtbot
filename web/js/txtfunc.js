...
<br>
<br>
<span id="NoteTxtHolder" style="color: rgb(255, 0, 0);"></span>
</span>
`
	return str
	}else{
...
function FinalProofTail(){
  ...
  function addNoteInputForm(obj){
    var main = document.createElement("form")
    var inputTxt =  document.createElement("input")
    var inputbtn =  document.createElement("input")
    inputTxt.setAttribute("type", "text")
    inputTxt.setAttribute("id", "NoteInputText")
    inputTxt.setAttribute("placeholder", "egg. add note")
    inputbtn.setAttribute("type", "button")
    inputbtn.setAttribute("onclick", "addToSpan()")
    inputbtn.setAttribute("value", "add")
    inputbtn.setAttribute("class", "button")
    main.appendChild(inputTxt)
    main.appendChild(inputbtn)
    obj.appendChild(main)
  }

function addToSpan(){
    var anchor = document.getElementById("NoteTxtHolder");
    var input = document.getElementById("NoteInputText");
    var span = document.createElement("span");
    span.setAttribute("onclick", "clearNote(this)")
